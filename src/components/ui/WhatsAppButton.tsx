...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-white text-background text-xs font-bold py-2 px-4 rounded shadow-xl whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
