      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-6 h-5 relative flex flex-col justify-between">
            <span className={cn("w-full h-[1px] bg-current transition-all", isMobileMenuOpen && "rotate-45 translate-y-2")} />
            <span className={cn("w-full h-[1px] bg-current transition-all", isMobileMenuOpen && "opacity-0")} />
            <span className={cn("w-full h-[1px] bg-current transition-all", isMobileMenuOpen && "-rotate-45 -translate-y-2")} />
          </div>
        </button>
      </div>
