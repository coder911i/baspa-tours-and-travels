...
export const tours: Tour[] = [
  {
    ...
    itinerary: [
      { day: 1, title: "The Journey Begins & Chitkul Arrival", description: "Enter the spectacular Kinnaur Valley via Karcham Dam and Sangla. Arrive at Chitkul, the last inhabited village on the Indo-Tibetan border. Visit the 500-year-old Mathi Temple and dine at the famous 'Last Dhaba of India'.", altitude: "3,450m", distance: "Shimla to Chitkul", stay: "Chitkul Homestay", highlights: ["Karcham Dam", "Sangla Valley", "Last Dhaba of India", "Mathi Temple"] },
      { day: 2, title: "Baspa River & Border Region", description: "Visit the Nagasthi ITBP Checkpost, the last civilian access point. Experience thrilling offroading along the Baspa River and immerse yourself in an authentic Kinnauri village experience.", altitude: "3,450m", distance: "Local", stay: "Chitkul Homestay", highlights: ["Nagasthi ITBP Checkpost", "Baspa River Offroad", "Kinnauri Culture"] },
      { day: 3, title: "The Confluence & Canyons", description: "Witness Khab Sangam (Spiti-Sutlej confluence) and navigate the thrilling Ka Loops. Visit Nako Lake, Gue Monastery, and the Shipki La View Region (Note: Civilians are not permitted at the actual border pass, but we view Tibet settlements from a designated region subject to visibility).", altitude: "3,662m", distance: "150 km", stay: "Nako/Tabo Homestay", highlights: ["Khab Sangam", "Ka Loops", "Nako Lake", "Gue Mummy", "Shipki La View Region"] },
      { day: 4, title: "Ancient Caves & Mud Castles", description: "Step back in time at Tabo Monastery (996 AD), the 'Ajanta of the Himalayas'. Explore the cliffside Dhankar Monastery, hike to Dhankar Lake, and end the day with views of the majestic Pin Valley.", altitude: "3,800m", distance: "80 km", stay: "Kaza Homestay", highlights: ["Tabo Monastery", "Dhankar Monastery", "Pin Valley"] },
      { day: 5, title: "The Spiti Heartlands", description: "Cross Chicham Bridge (Asia's highest suspension bridge). Visit Key Monastery, Kibber, and Hikkim (World's Highest Post Office). Hunt for fossils in Langza and explore Komic – World's Highest Motorable Village.", altitude: "4,587m", distance: "60 km", stay: "Kaza Homestay", highlights: ["Chicham Bridge", "Komic - World's Highest Motorable Village", "Langza Fossils", "Key Monastery"] },
      { day: 6, title: "Adventure & Return Journey", description: "Enjoy ATV rides in the high-altitude desert, relax at cozy local cafes, and shop for authentic Spitian handicrafts before starting the descent towards Shimla.", altitude: "2,050m", distance: "250 km", stay: "Shimla Hotel / Volvo", highlights: ["ATV Rides", "Cafe Hopping", "Handicrafts Shopping"] },
