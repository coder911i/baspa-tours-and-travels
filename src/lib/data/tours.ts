...
export const tours: Tour[] = [
  {
    ...
    itinerary: [
      { day: 0, title: "Delhi to Shimla", description: "Assemble at Kashmiri Gate / Majnu Ka Tila. Meet your boarding captain and co-travelers. Group briefing and induction. Overnight journey to Shimla.", altitude: undefined, distance: "~360 km", stay: "Overnight Bus", highlights: ["Boarding Point: Kashmiri Gate", "Group Induction Session", "Overnight Volvo/Deluxe Bus"] },
  ...
  },
  {
    ...
    itinerary: [
      { day: 0, title: "Delhi to Manali", description: "Depart Delhi at 7 PM. Board overnight Volvo to Manali.", altitude: undefined, distance: "~550 km", stay: "Overnight Bus", highlights: ["Depart 7 PM from Delhi", "Overnight Volvo Bus"] },
      ...
      { day: 5, title: "Departure via Manali", description: "Post breakfast, drive back to Manali via Atal Tunnel. Leisure time at cafés. Board evening Volvo to Delhi. Reach Delhi next morning.", altitude: undefined, distance: "~230 km", stay: "Overnight Bus", highlights: ["Atal Tunnel Return", "Café Time in Manali", "Evening Volvo to Delhi"] }
    ]
  },
  {
    id: "winter-spiti-9d",
    ...
    itinerary: [
      { day: 1, title: "Delhi to Shimla", description: "Depart Delhi around 9:30 PM. Reach Shimla the next morning.", altitude: undefined, distance: "~370 km", stay: "Overnight Bus", highlights: ["Night departure from Delhi"] },
      ...
      { day: 8, title: "Kalpa to Shimla", description: "Post breakfast, drive to Shimla through Satluj riverside and Deodhar forests. Board AC Volvo bus to Delhi from Shimla Bus Stand.", altitude: undefined, distance: "~235 km", stay: "Overnight Bus", highlights: ["Deodhar Forest Drive", "Satluj Riverside Road", "Board Volvo to Delhi"] },
      { day: 9, title: "Reach Delhi", description: "Arrive Delhi around 7–8 AM with a lifetime of memories.", altitude: undefined, distance: undefined, stay: "Home", highlights: ["Arrive Delhi 7–8 AM", "Trip Ends with Memories"] }
    ]
  }
];
